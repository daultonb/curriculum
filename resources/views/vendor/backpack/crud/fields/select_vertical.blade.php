<!-- Not Finished. select2 multiple, but displays vertically like a table showing any number of attributes. shortest path to the goal (adding pivot table records that are detailed and likely to be multiple in number) -->
@php
...
@if ($crud->fieldTypeNotLoaded($field))
    ...
    @push('crud_fields_scripts')
        ...
        <script>
            ...
            function deboot(){
                    $("[data-select2-id]=6").removeClass("select2-container--bootstrap");
            }
            setTimeout(deboot,1000);
        </script>
    @endpush
